  ...
  return (
    <footer className="mt-12 bg-[#232326] text-white md:mt-16">
      <div className="mx-auto grid max-w-content gap-8 px-4 py-10 sm:px-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-end lg:px-8">
        <div>
          <p className="text-xl font-bold">CampusMate</p>
      ...
      <div className="border-t border-white/10"><p className="mx-auto max-w-content px-4 py-4 text-xs text-white/50 sm:px-6 lg:px-8">CampusMate · 南京大学校园团队</p></div>
    </footer>
  )
}
