...
export default function Home() {
  ...
  return (
    <div
      aria-busy={loading}
      className="grid min-w-0 grid-cols-1 gap-8 animate-slide-up lg:grid-cols-[minmax(0,280px)_minmax(0,1fr)] lg:gap-10"
    >
      <aside aria-label="我的首页摘要" className="min-w-0 space-y-5">
        ...
        {followedDegraded ? (
          ...
          <MyEventsSummary attending={[]} saved={feed.followed_topics} />
        )}
        {groupsDegraded ? (
